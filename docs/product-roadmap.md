...
Checkpoint 3 will connect live SimConnect latitude, longitude, and heading to the globe. Replace the current outlined progress aircraft with a clean filled yellow side-profile silhouette consistent with the dashboard route graphic. The globe marker will move continuously, rotate with aircraft heading, remain legible at every supported zoom level, and distinguish the completed track from the remaining yellow SimBrief route.
