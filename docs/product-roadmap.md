...
Checkpoint 2 will also remove the dashboard hero's three-dot Flight Tools button. **View Flight Deck** already opens the same workspace, so the duplicate control is unnecessary.
