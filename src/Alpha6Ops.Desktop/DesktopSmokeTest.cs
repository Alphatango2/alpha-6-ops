...
internal static class DesktopSmokeTest
{
    internal static async Task RunAsync(MainWindow window, string outputDirectory)
    {
        ...
        try
        {
            ...
            if (imported.Plan.FlightNumber != "JBU124" || imported.Plan.Origin != "KLAX" || imported.Plan.Destination != "KJFK" || imported.Plan.Registration != "N123JB" || imported.AircraftType != "A321" || imported.Plan.AircraftType != "A321" || imported.CruiseAltitudeFeet != 35000 || imported.RampFuel != 42000 || imported.FuelUnits != "LBS" || imported.Plan.DepartureGate != "52A" || imported.Plan.ArrivalGate != "12" || imported.Plan.GateAssignmentConfidence != "High" || imported.Plan.Route != "DCT TEST" || imported.Plan.RoutePoints?.Count != 4 || imported.Plan.RoutePoints[0].Ident != "KLAX" || imported.Plan.RoutePoints[^1].Ident != "KJFK")
